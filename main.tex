...
% https://github.com/mlopes93/TCC_Modelo-IFMG-Betim
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{2-Textual/2-Referencial-Teorico.tex}
\input{2-Textual/3-Metodologia.tex}
\input{2-Textual/4-Resultados.tex}
\input{2-Textual/5-Conclusao.tex}
\input{2-Textual/6-Sugestoes.tex}
